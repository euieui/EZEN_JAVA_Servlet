...
<body>
<h3>톰캣 서버의 기본 로케일 : <%= response.getLocale() %> </h3><br><hr>
<!-- 혹시 다른 곳으로 되어 있다면  -->
<fmt:setLocale value="ko_KR"></fmt:setLocale>
<h3>로케일을 한국으로 설정후 로케일 확인 : <%=response.getLocale() %></h3><br><hr>
<h3>
통화(currency) : <fmt:formatNumber value="10000" type="currency"></fmt:formatNumber><br>
숫자(number) : <fmt:formatNumber value="1000.1234" type="number" maxFractionDigits="2"></fmt:formatNumber><br>
