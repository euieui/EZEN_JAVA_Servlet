...
<!-- 각 객체의 저장된 Attribute의 이름이 중복되면, 우선순위를 부여해서 pageContext에 저장된 Attribute가 적용되어 출력됩니다.
만약 pageContext가 없다면 request에 저장된 같은 이름의 Attribute가 출력 되고 request 가 없다면 session 에 ...
session 에 저장된 같은 이름의 Attribute가 없다면 application 에 있는 Attribute가 출력됩니다.-->
name : ${name}<hr>
