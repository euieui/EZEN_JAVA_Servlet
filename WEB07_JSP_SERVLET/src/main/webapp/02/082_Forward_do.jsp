...
<%} else {
	...
	// 083_ForwardResult.jsp 에서는 이전 페이지에서 보내준  request와 response를 이용해서
	...
	//추출하여ㅕ 사용하지만, 위의 RequestDispatcher는 전달인수 대신 request 내부의
	//Attribute 를 사용하여 전달인자를 저장하고, 수명을 다할지 모를 이전 페이지의 request와 
	//response를 전달인수로 전달하여 forward라는 명령으로 페이지를 이동한 다음..
	// 이동한 페이지에서 Attribute를 사용하게 됩니다.
}%>